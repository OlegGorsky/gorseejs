...
- `node scripts/release-smoke.mjs` validates packed starter creation, standalone `create-gorsee`, canonical example sandbox builds, and deploy-generator behavior.
