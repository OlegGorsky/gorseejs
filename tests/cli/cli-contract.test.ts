...
describe("cli contract", () => {
  test("keeps the top-level command matrix aligned across code and docs", () => {
    ...
    expect(readme).toContain("docs/PRODUCT_SURFACE_AUDIT.md")
    expect(readme).toContain("docs/AI_INTEGRATION_CONTRACT.json")
    expect(agentsDoc).toContain("docs/PRODUCT_SURFACE_AUDIT.md")
    expect(agentsDoc).toContain("docs/AI_INTEGRATION_CONTRACT.json")
    expect(agentsDoc).toContain("docs/TEST_COVERAGE_AUDIT.md")
    expect(agentsDoc).toContain("docs/REACTIVE_MEASUREMENT_CONTRACT.json")
